<template>
  <div id="app">
    <div class="main-header">
      ...
      <div class="main-header-title">X-UI-Docs</div>
...
<script>
import { navList } from "./static/nav.js";
export default {
  name: "App",
  data() {
    return {
...
.markdown h1:hover .sh-markdown-permalink, .markdown h2:hover .sh-markdown-permalink, .markdown h3:hover .sh-markdown-permalink, .markdown h4:hover .sh-markdown-permalink, .markdown h5:hover .sh-markdown-permalink, .markdown h6:hover .sh-markdown-permalink {
  opacity: 1;
  display: inline-block;
}
